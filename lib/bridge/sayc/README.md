...
| Run | Result |
| --- | --- |
| seed 1, 3000 deals (test set) | 650 findings, 0 hard failures |
| seed 42, 4000 deals (dev) | 881 findings, 0 hard failures |
| chaos 0.15, 5000 deals | 0 hard failures |

Seed 1 findings by category: fallback-used 441, missed-game 138,
